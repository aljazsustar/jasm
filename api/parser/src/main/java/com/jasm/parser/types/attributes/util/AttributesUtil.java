...
import com.jasm.parser.types.attributes.util.types.code.Exception;
...
import com.jasm.parser.types.attributes.util.types.stackMapTable.stackMapFrameTypes.*;
import com.jasm.parser.types.attributes.util.types.stackMapTable.verificationTypes.*;
...
import com.jasm.parser.types.attributes.util.types.annotations.*;
...
public class AttributesUtil {
    ...
    public static Exceptions parseExceptions(BufferedInputStream inputStream, ConstantPool constantPool, Integer exceptionTableLength) {
        ...
        for (Integer i = 0; i < exceptionTableLength; i++) {
            ...
            com.jasm.parser.types.attributes.util.types.code.Exception exception = new Exception(startPc, endPc, handlerPc, catchTypeIndex, catchType);
