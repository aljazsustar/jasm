...
import com.example.jasm_parser.types.constantPool.constants.*;
import com.example.jasm_parser.types.constantPool.constants.methods.InterfaceMethodRefConstant;
import com.example.jasm_parser.types.constantPool.constants.methods.MethodHandleConstant;
import com.example.jasm_parser.types.constantPool.constants.methods.MethodRefConstant;
import com.example.jasm_parser.types.constantPool.constants.methods.MethodTypeConstant;
import com.example.jasm_parser.types.constantPool.constants.numeric.DoubleConstant;
import com.example.jasm_parser.types.constantPool.constants.numeric.FloatConstant;
import com.example.jasm_parser.types.constantPool.constants.numeric.IntegerConstant;
import com.example.jasm_parser.types.constantPool.constants.numeric.LongConstant;
import com.example.jasm_parser.types.constantPool.constants.strings.StringConstant;
