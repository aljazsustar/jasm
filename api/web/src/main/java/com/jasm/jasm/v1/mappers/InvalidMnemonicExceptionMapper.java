...
@Provider
public class InvalidMnemonicExceptionMapper implements ExceptionMapper<InvalidMnenonicException> {

    @Override
    public Response toResponse(InvalidMnenonicException exception) {
